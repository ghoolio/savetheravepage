    ...
    return (
        <header className="relative">
            <div className="absolute w-full z-50">
                <div className='flex justify-between items-center px-12 p-4 drop-shadow-sm'>
                    <div 
                    ...
                    <div className='hidden lg:inline'>
                        <ul className="flex justify-center hover:cursor-pointer pl-20">
                        {links.map((link) => {
                            return (
                    ...
                    <div className='hidden lg:inline'>
                        <ul className="flex justify-center hover:cursor-pointer">
                            <li className='text-white py-5 px-2 hover:rounded drop-shadow-sm'>
                            ...
                            <li>
                                ...
                                <div className="justify-center lg:flex py-4 pl-2 inset-x-0 bottom-[10.5%]">
                                    <SignedIn>
